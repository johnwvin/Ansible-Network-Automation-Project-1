pipeline {
    ...
    stages {
        ...
        stage('Pull Ansible Image') {
            steps {
                sh '''
                    ...
                    docker pull nexus.johnwvin.com:14443/repository/docker/ansible/ansible
        ...
        stage('Run Lint in Container') {
            steps {
                script {
                    docker.image('nexus.johnwvin.com:14443/repository/docker/ansible/ansible').inside('-u root:root') {
                        sh '''
